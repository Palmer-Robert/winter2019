...
public class BasicsDemo {
    ...
    static void print() {
        System.out.println("\n\nInside print ..."); //Drops 2 lines before printing the words
        //The cursor moves to the next line after it prints
    ...
    */
    ...
    static void arrays() {
        ...
        System.out.println("myArray[7]: " + myArray[6]);//Throws an error because there is no 7th place available
        System.out.println("myArray[7]: " + myArray[4]);
        System.out.println("myArray[7]: " + myArray[3]);
    }
    ...
    static void threeDimensionalArrays() {
	   ...
	   int[][][] unitsSold = new int[][][]{ 
		...
		System.out.println("unitsSold[0][3][1]: " + unitsSold[0][3][1]);
                System.out.println("unitsSold[3][1][2]: " + unitsSold[3][1][2]);
	}
